...
示例：
python 批量单文件压缩移动.py "G:\\Submit" "G:\\ZipOut"
python 批量单文件压缩移动.py "G:\\Submit" "G:\\ZipOut" --recursive --workers 16
python 批量单文件压缩移动.py "G:\\Submit" "G:\\ZipOut" --method store
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("out_dir", type=Path, help="压缩包输出/移动到的目标文件夹")
    ...
    parser.add_argument("--overwrite", action="store_true", help="允许覆盖目标目录中已有同名 zip 包")
